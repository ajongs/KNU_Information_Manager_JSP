...
<div class="container-fluid">
  <div class="row flex-nowrap">
	...
	<!-- Large button group -->
	<span style="font-size:40px; margin-right:10px;">공지사항(컴퓨터공학부)</span><br>
	<div class="btn-group">
		<button class="btn-site site-selected" id="btn-knu" onclick="location.href='notice.jsp'">공주대학교</button>
		<button class="btn-site" id="btn-cse">컴퓨터공학부</button>
	</div>
	<br><span> 키워드 
