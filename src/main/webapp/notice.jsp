...
<script>
	...
	function kurl(url){
		var newUrl = "https://www.kongju.ac.kr"+url;
		console.log(newUrl);
		return newUrl;
	}
</script>
...
<form name="viewForm" method="post">
	<input type="hidden" name="layout" value="ylSMW362wYQN%2B2qo%2BkZuI7ECT9MbeWxhVFwsIyGN%2F0c%3D">
</form>
...
<div class="container-fluid">
  <div class="row flex-nowrap">
    <div class="col-3 bd-sidebar">
        <nav id="sidebar">
				...
				<ul class="list-unstyled componenets">
					...
					<li id="selected"><a href="notice.jsp"><span>공지사항</span></a></li>
	...
	<span style="font-size:40px; margin-right:10px;">공주대학교 공지사항</span><br>
	<div class="btn-group">
		<button class="button1" id="btn-knu">공주대학교</button>
		<button class="button1" id="btn-cse" onclick="location.href='btn_cse_click.jsp'">컴퓨터공학부</button>
	</div>
	<br><span> 키워드 
...
<%
	...
	int count =0;
	//String URL_KNU = "https://www.kongju.ac.kr/kor/article/student_news/?mno=&pageIndex=";
	String URL_KNU = "https://www.kongju.ac.kr/kongju/12499/subview.do";
	String URL_href = "https://www.kongju.ac.kr/kor/article/student_news/";
	// 파싱할 사이트를 적어준다(해당 사이트에 대한 태그를 다 긁어옴)
	Document doc;
	for (int i = 0; i < 5; i++) {
		//doc = Jsoup.connect(URL_KNU + i).get();
		doc = Jsoup.connect(URL_KNU).data("page", Integer.toString(i)).post();
